create database finalsergiovega;
...
/* Seleccione la actividad numero 12*/

SELECT ID_Perro, Nombre FROM Perro WHERE Sexo ="Macho" and Fecha_nac BETWEEN  2020 and 2022;
