...
# 9530, 4120, 4580, 1500, 890, 7516, 426, que representa montos de atención en pesos
# por diferentes servicios/consultas de la mascota “Lennon”.
...
print ("El promedio de gasto en pesos por atención de Lennon es "+ str(promedio) + ".")
if promedio > 4500:
